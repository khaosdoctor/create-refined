package com.khaosdoctor.refined_integrations.external_storage_interface.rs_integration;

import com.khaosdoctor.refined_integrations.Config;
 ...
 * - If energy > 0: Requires a network with a Controller (Controllers provide
 * energy)
 * - If energy = 0: Works without a controller (always active if connected to
 * cables)
 * - Network must have at least this much FE/t available
 * - If network runs out of energy, this block becomes inactive (POWERED =
 * false)
